...
?>
  ...
  <div class="stats-grid">
    <div class="stat-card bg-yellow">🟩<h3><?= $total_ya ?></h3>
      <p>Total "Ya"</p><small><?= $persen_ya ?>%</small>
    </div>
    <div class="stat-card bg-red">❌<h3><?= $total_tidak ?></h3>
      <p>Total "Tidak"</p><small><?= $persen_tidak ?>%</small>
    </div>
    ...
    <div class="stat-card bg-green">✅<h3><?= $total_persen ?>%</h3>
      <p>Rata-rata Kepatuhan</p>
    </div>
    <div class="stat-card <?= $warna_status ?>">🏆<h3><?= $status_kepatuhan ?></h3>
    ...
    new Chart(document.getElementById('chartBar'), {
      ...
      options: {
        ...
        plugins: {
          ...
          title: {
            display: true,
            text: 'Perbandingan Tiap Komponen Cuci Tangan'
          }
        }
      }
    });

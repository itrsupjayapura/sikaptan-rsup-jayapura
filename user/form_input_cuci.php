...
// Ambil data observasi cuci tangan yang aktif
$data_observasi = mysqli_query($conn, "
    SELECT * FROM data_observasi_cuci_tangan
    WHERE status='aktif'
...
<head>
<meta charset="UTF-8">
<title>Pilih Ruangan Observasi Cuci Tangan - RSUP Jayapura</title>
...
<div class="container">
    <div class="header-box">
        ...
        <h2>🧼 Pilih Ruangan untuk Observasi Cuci Tangan</h2>
    </div>
    ...
    <div class="row g-4 justify-content-center">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
            <div class="ruangan-card">
                ...
                <a href="form_observasi_cuci.php?id=<?= $r['id'] ?>" class="btn w-100">Buka Form</a>
            </div>
        </div>
        <?php endwhile; ?>

        <?php if (mysqli_num_rows($data_observasi) == 0): ?>
        <p class="no-data text-center">⚠️ Belum ada data observasi cuci tangan aktif. Silakan hubungi admin.</p>
        <?php endif; ?>
    </div>
